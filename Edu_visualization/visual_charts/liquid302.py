...
data1 = data.loc[(data['课程号'].map(str) == '1') & (data['班级'].map(str) == '302')]["分数"].tolist()
data2 = data.loc[(data['课程号'].map(str) == '2') & (data['班级'].map(str) == '302')]["分数"].tolist()
data3 = data.loc[(data['课程号'].map(str) == '3') & (data['班级'].map(str) == '302')]["分数"].tolist()
...
chart_liquid01_.render('../../templates/visual/pyecharts_visual/liquid_c2_01.html')
chart_liquid02_.render('../../templates/visual/pyecharts_visual/liquid_c2_02.html')
chart_liquid03_.render('../../templates/visual/pyecharts_visual/liquid_c2_03.html')
