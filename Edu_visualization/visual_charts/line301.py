...
xaxis_data = data.loc[(data['课程号'].map(str) == '1') & (data['班级'].map(str) == '301')]["学号"].map(str).tolist()
...
def line():
    chart_line = (
        ...
        .set_global_opts(
            ...
            title_opts=opts.TitleOpts(title="301班各学科学生成绩", title_link="#"),
...
chartLine = line()
chartLine.render("../../templates/visual/pyecharts_visual/line301.html")
